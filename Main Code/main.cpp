...
{
    string s;
    for(int i=0;i<strlen(buffer);i++) s=s+buffer[i];
    return s;
}
...
void Control_Wait_Menu(Game_State *game,Input_State *input)
{
    ...
    pause_button={850,340,150,150};
    guild_button={1050,390,100,100};
    quit_button={1200,390,100,100};
    out_button={1700,0,100,100};
    restart_button={550,390,100,100};
    music_button={700,390,100,100};
    menu_table={550,250,750,250};
...
void Prepare()
{
    ...
    surface=IMG_Load("button/Play1.png");
    Play1=SDL_CreateTextureFromSurface(renderer,surface);
    surface=IMG_Load("button/Play2.png");
    ...
    surface=IMG_Load("button/Out1.png");
    Out1=SDL_CreateTextureFromSurface(renderer,surface);
    surface=IMG_Load("button/Out2.png");
    Out2=SDL_CreateTextureFromSurface(renderer,surface);
    surface=IMG_Load("button/Restart1.png");
    Restart1=SDL_CreateTextureFromSurface(renderer,surface);
    surface=IMG_Load("button/Restart2.png");
    Restart2=SDL_CreateTextureFromSurface(renderer,surface);
...
void Free_Data()
{
    ...
    SDL_DestroyTexture(Out1);
    SDL_DestroyTexture(Out2);
    SDL_DestroyTexture(Restart1);
    SDL_DestroyTexture(Restart2);
...
int main(int argv,char *argc[])
{
    ...
    window=SDL_CreateWindow("GAME",SDL_WINDOWPOS_UNDEFINED,SDL_WINDOWPOS_UNDEFINED,window_width,window_height,SDL_WINDOW_OPENGL);
